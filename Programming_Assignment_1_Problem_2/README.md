The program was to determine if a string entered was a palindrome. The user is prompted for input and would have the string passed to a seperate function to determine if it was indeed a palindrome.
